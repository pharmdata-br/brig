# Status de Substância GSRS/Brasil - BRIG - Guia de Implementação Brasileiro para IDMP v0.0.3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Status de Substância GSRS/Brasil**

## ValueSet: Status de Substância GSRS/Brasil (Experimental) 
...
Conjunto de valores para status de substâncias GSRS e brasileiro 
...
* Incluir todos os códigos definidos em [`http://farmaco.maxapex.net/brig/fhir/CodeSystem/gsrs-substance-status-br`](CodeSystem-gsrs-substance-status-br.md)versão 📦0.0.3
* Incluir todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/substance-status-br`versão Not Stated (use latest from terminology server)

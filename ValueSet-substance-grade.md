...
## ValueSet: Grau de Substância (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-grade | *Version*:0.0.3 |
...
Graus ou qualidades de substâncias (padrão internacional - USP/EP/JP) 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/substance-grade`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-grade",
  "version" : "0.0.3",
  "name" : "SubstanceGrade",

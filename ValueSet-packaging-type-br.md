...
## ValueSet: Tipos de Embalagem - Brasil (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/packaging-type-br | *Version*:0.0.3 |
...
Tipos de embalagem utilizados para produtos farmacêuticos no Brasil 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/packaging-type-br`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/packaging-type-br",
  "version" : "0.0.3",

...
Classificação de confidencialidade para produtos medicinais 
...
* Include todos os códigos definidos em [`https://idmp-br.github.io/brig-idmp-brasil/CodeSystem/product-confidentiality`](CodeSystem-product-confidentiality.md)versão 📦0.0.3

 

### Expansion

Expansão efectuada internamente com base em [codesystem Confidencialidade de Produto Medicinal v0.0.3 (CodeSystem)](CodeSystem-product-confidentiality.md)

...
## ValueSet: Finalidades de Contato Organizacional (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/organization-contact-purpose | *Version*:0.0.3 |
...
Finalidades específicas de contatos organizacionais (padrão internacional) 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/organization-contact-purpose`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/organization-contact-purpose",
  "version" : "0.0.3",

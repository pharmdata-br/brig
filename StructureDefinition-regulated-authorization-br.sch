...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:RegulatedAuthorization">
      ...
      <sch:assert test="count(f:regulator) &gt;= 1">regulator: minimum cardinality of 'regulator' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:RegulatedAuthorization/f:validityPeriod</sch:title>

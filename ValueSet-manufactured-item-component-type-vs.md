# Tipo de Componente - BRIG - Guia de Implementação Brasileiro para IDMP v0.0.3
...
* Include todos os códigos definidos em [`https://idmp-br.github.io/brig-idmp-brasil/CodeSystem/manufactured-item-component-type`](CodeSystem-manufactured-item-component-type.md)versão 📦0.0.3

 

### Expansion

Expansão efectuada internamente com base em [codesystem Tipo de Componente de Item Manufaturado v0.0.3 (CodeSystem)](CodeSystem-manufactured-item-component-type.md)

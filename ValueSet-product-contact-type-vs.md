...
* Include todos os códigos definidos em [`https://idmp-br.github.io/brig-idmp-brasil/CodeSystem/product-contact-type`](CodeSystem-product-contact-type.md)versão 📦0.0.3

 

### Expansion

Expansão efectuada internamente com base em [codesystem Tipos de Contato para Produto Medicinal v0.0.3 (CodeSystem)](CodeSystem-product-contact-type.md)

...
* Include todos os códigos definidos em [`https://idmp-br.github.io/brig-idmp-brasil/CodeSystem/warning-type`](CodeSystem-warning-type.md)versão 📦0.0.3

 

### Expansion

Expansão efectuada internamente com base em [codesystem Tipo de Advertência v0.0.3 (CodeSystem)](CodeSystem-warning-type.md)

...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:PackagedProductDefinition/f:marketingStatus/f:dateRange</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PackagedProductDefinition/f:packaging">
      ...
      <sch:assert test="count(f:containedItem) &gt;= 1">containedItem: minimum cardinality of 'containedItem' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:PackagedProductDefinition/f:packaging/f:containedItem">
      <sch:assert test="count(f:extension[@url = 'http://farmaco.maxapex.net/brig/fhir/StructureDefinition/manufactured-item-criteria']) &lt;= 1">extension with URL = 'http://farmaco.maxapex.net/brig/fhir/StructureDefinition/manufactured-item-criteria': maximum cardinality of 'extension' is 1</sch:assert>

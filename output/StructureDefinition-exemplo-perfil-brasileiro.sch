...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DomainResource">
      <sch:assert test="count(f:extension[@url = 'http://farmaco.maxapex.net/brig/fhir/StructureDefinition/documentation-language']) &gt;= 1">extension with URL = 'http://farmaco.maxapex.net/brig/fhir/StructureDefinition/documentation-language': minimum cardinality of 'extension' is 1</sch:assert>

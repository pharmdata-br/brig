...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:AdministrableProductDefinition/f:property/f:type</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:AdministrableProductDefinition/f:property/f:type/f:coding</sch:title>
    <sch:rule context="f:AdministrableProductDefinition/f:property/f:type/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>

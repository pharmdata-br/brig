...
## ValueSet: Tipos de Nome de Produto (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/product-name-type | *Version*:0.0.3 |
...
Tipos de nomes para produtos medicinais (padrão internacional) 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/product-name-type`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/product-name-type",
  "version" : "0.0.3",

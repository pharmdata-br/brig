...
## ValueSet: Status Legal de Fornecimento - Brasil (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/legal-status-supply-br | *Version*:0.0.3 |
...
Status legal para dispensação de produtos medicinais no Brasil 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/legal-status-supply-br`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/legal-status-supply-br",
  "version" : "0.0.3",

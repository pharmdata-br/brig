...
## ValueSet: Características de Embalagem - Brasil (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/package-characteristic-br | *Version*:0.0.3 |
...
Características especiais de embalagens farmacêuticas no Brasil 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/package-characteristic-br`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/package-characteristic-br",
  "version" : "0.0.3",

...
## ValueSet: Tipos de Nome de Substância (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-name-type | *Version*:0.0.3 |
...
Tipos de nomes para substâncias (padrão internacional - INN/IUPAC) 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/substance-name-type`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-name-type",
  "version" : "0.0.3",

...
## ValueSet: Status de Substância - Brasil (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-status-br | *Version*:0.0.3 |
...
Status regulatório de substâncias no contexto brasileiro 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/substance-status-br`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-status-br",
  "version" : "0.0.3",

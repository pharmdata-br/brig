...
## ValueSet: Tipos de Produto Medicinal - Brasil (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/medicinal-product-type-br | *Version*:0.0.3 |
...
Tipos de produtos medicinais conforme classificação brasileira/ANVISA 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/medicinal-product-type-br`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/medicinal-product-type-br",
  "version" : "0.0.3",

...
## ValueSet: Classificação de Substância - Brasil (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-classification-br | *Version*:0.0.3 |
...
Classificação de substâncias no contexto brasileiro/ANVISA 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/substance-classification-br`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/substance-classification-br",
  "version" : "0.0.3",

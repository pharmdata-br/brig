...
## ValueSet: Características de Produto Medicinal 
...
Características observáveis de produtos medicinais. Alternativa brasileira ao SNOMED CT Observable Entity. 

 
Fornecer vocabulário padronizado para descrever características de produtos medicinais em contexto regulatório brasileiro 
...
* Include todos os códigos definidos em [`https://idmp-br.github.io/brig-idmp-brasil/CodeSystem/product-characteristic`](CodeSystem-product-characteristic.md)versão 📦0.0.3

 

### Expansion

Expansão efectuada internamente com base em [codesystem Características de Produto Medicinal v0.0.3 (CodeSystem)](CodeSystem-product-characteristic.md)

Este conjunto de valores contém 30 conceitos
...
```json
{
  ...
  "purpose" : "Fornecer vocabulário padronizado para descrever características de produtos medicinais em contexto regulatório brasileiro",

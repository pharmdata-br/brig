...
## ValueSet: Tipos de Produto Embalado - Brasil (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/packaged-product-type-br | *Version*:0.0.3 |
...
Tipos de produtos embalados utilizados no contexto regulatório brasileiro 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/packaged-product-type-br`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/packaged-product-type-br",
  "version" : "0.0.3",

# Dipirona 500mg Comprimido - BRIG - Guia de Implementação Brasileiro para IDMP v0.0.3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dipirona 500mg Comprimido**

## Example MedicinalProductDefinition: Dipirona 500mg Comprimido
...
**identifier**: `http://farmaco.maxapex.net/brig/fhir/CodeSystem/mpid`/BRIG-MPID-DIP-500, `http://www.anvisa.gov.br/registro`/100000000001
...
**legalStatusOfSupply**: Prescrição Médica

**classification**: metamizole sodium
...
> **name****productName**: Dipirona 500mg**type**:commercial
...
**effectiveDate**: 2024-01-01 --> (em curso)**organization**:[Organization Laboratório Exemplo S.A.](Organization-manufacturer-example.md)

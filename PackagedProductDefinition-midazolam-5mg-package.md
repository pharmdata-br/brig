# Exemplo - Midazolam 5mg/mL Embalagem - BRIG - Guia de Implementação Brasileiro para IDMP v0.0.3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Exemplo - Midazolam 5mg/mL Embalagem**

## Example PackagedProductDefinition: Exemplo - Midazolam 5mg/mL Embalagem

| |
| :--- |
| *Page standards status:*[Informative](http://hl7.org/fhir/R5/versions.html#std-process) |

## Midazolam Cristália 5mg/mL - Embalagem

**EAN/GTIN:** 7891234567891

**Código ANVISA:** PKG-MID-5MG-10AMP

**Conteúdo:** 10 ampolas de 3mL (5mg/mL)

**Embalagem:** Caixa de papelão com ampolas de vidro âmbar

**Armazenamento:** Conservar sob refrigeração, proteger da luz

**Status:** Medicamento controlado - Prescrição médica obrigatória

**Fabricante:** Cristália Brasil

**Produto base:** Midazolam 5mg/mL injetável

**Classificação:** Medicamento hospitalar de uso controlado
...
```json
{
  ...
  "identifier" : [
    {
      ...
      "value" : "BR-CRISTALIA-567890-P001"
    },
    {
  ...
  "packageFor" : [
    {
      "reference" : "MedicinalProductDefinitionBR/midazolam-5mg-injection"
    }
  ],
  "legalStatusOfSupply" : [
    {
  ...
  "manufacturer" : [
    {
      "reference" : "OrganizationANVISASimple/cristalia-brasil"
    }
  ],
  "packaging" : {
    "type" : {
            ...
            "coding" : [
              {
                ...
                "code" : "midazolam-amp-5mg-3ml",
                "display" : "Midazolam 5mg/mL ampola 3mL"
              }
            ]
          }
        },
  ...
  "characteristic" : [
    ...
    },
    {
      ...
      "valueCodeableConcept" : {
        "coding" : [
          {
            "system" : "http://farmaco.maxapex.net/brig/fhir/CodeSystem/protection-br",
            "code" : "proteger-luz",
            "display" : "Proteger da luz"
          }
        ]
      }
    }

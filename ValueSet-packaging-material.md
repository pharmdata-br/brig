...
## ValueSet: Materiais de Embalagem (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://idmp-br.github.io/brig-idmp-brasil/ValueSet/packaging-material | *Version*:0.0.3 |
...
Materiais utilizados em embalagens farmacêuticas (padrão internacional) 
...
* Include todos os códigos definidos em `http://farmaco.maxapex.net/brig/fhir/CodeSystem/packaging-material`versão Not Stated (use latest from terminology server)
...
```json
{
  ...
  "url" : "https://idmp-br.github.io/brig-idmp-brasil/ValueSet/packaging-material",
  "version" : "0.0.3",

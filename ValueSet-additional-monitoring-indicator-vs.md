...
## ValueSet: Indicador de Monitorização Adicional 
...
Indicadores de monitorização extra para produtos medicinais 
...
* Include todos os códigos definidos em [`https://idmp-br.github.io/brig-idmp-brasil/CodeSystem/additional-monitoring-indicator`](CodeSystem-additional-monitoring-indicator.md)versão 📦0.0.3

 

### Expansion

Expansão efectuada internamente com base em [codesystem Indicador de Monitorização Adicional v0.0.3 (CodeSystem)](CodeSystem-additional-monitoring-indicator.md)

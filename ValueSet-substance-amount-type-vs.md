# Tipo de Quantidade de Substância - BRIG - Guia de Implementação Brasileiro para IDMP v0.0.3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tipo de Quantidade de Substância**

## ValueSet: Tipo de Quantidade de Substância 
...
* Include todos os códigos definidos em [`https://idmp-br.github.io/brig-idmp-brasil/CodeSystem/substance-amount-type`](CodeSystem-substance-amount-type.md)versão 📦0.0.3

 

### Expansion

Expansão efectuada internamente com base em [codesystem Tipo de Medida de Quantidade de Substância v0.0.3 (CodeSystem)](CodeSystem-substance-amount-type.md)
...
```json
{
  ...
  "title" : "Tipo de Quantidade de Substância",
  "status" : "active",
